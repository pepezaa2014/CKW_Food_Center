...
<font size="5" color="white"><form method="post" action="addmember1.php" autocomplete="off">
	...
	<a class="text">หมายเลขประจำตัว : </a> <input style="margin-left: 48px;"placeholder=" หมายเลขประจำตัว..." type="number" name="number" class="textbox"><br>
	<a class="text">รหัสผ่าน : </a><input style="margin-left: 110px;" placeholder=" กรอกรหัสผ่าน..." type="password" name="password" class="textbox"><br>
